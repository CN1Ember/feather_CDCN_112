...
parser.add_argument('--resume', default='/mnt/cephfs/home/chenguo/code/feather_CDCN_112/checkpoints/CDCFeatherNetA_nir_0613_0.7_32_0.01000_SGD_train_set_21030601_20210307104514_mask_False/_76_best.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
parser.add_argument('--val', '--evaluate', dest='evaluate', default=True, type=bool,
                    help='evaluate models on validation set')
parser.add_argument('--val-save', default=True, type=bool,
...
def main():
    ...
    val_dataset = CASIA(
        ...
        transforms.ToTensor(),
        normalize,
    ]), phase_train=False, phase_test=True)
