...
class CASIA(Dataset):
    def __init__(self,data_flag = None, transform=None, phase_train=None, data_dir=None,phase_test=None,add_mask = True):
        ...
        # for test
        test_file = os.getcwd() +'/data/test_file_list/nir_20210612_val.txt'
        label_test_file = os.getcwd() + '/data/test_file_list/nir_20210612_val_label.txt'

        self.mask_np = np.fromfile('./data/mask_file/mask_for_nir.bin', np.uint8).reshape((112,112))
        print("test",self.phase_test)
        print("train",self.phase_train)
